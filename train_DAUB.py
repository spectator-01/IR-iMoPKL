...
if __name__ == "__main__":
    ...
    num_train   = len(train_lines)  #7500
    num_val     = len(val_lines)    #2000
    ...
    if local_rank == 0:
        ...
        wanted_step = 5e4 if optimizer_type == "sgd" else 1.5e4 #50000 or 15000
        total_step  = num_train // Unfreeze_batch_size * UnFreeze_Epoch # 7500/4*30=56250
        #todo test
        print(f'wanted_step: {wanted_step}, total_step: {total_step}')
        #
    ...
    if True:
        ...
        epoch_step      = num_train // batch_size   #7500/4=1875
        epoch_step_val  = num_val // batch_size     #2000/4=500
