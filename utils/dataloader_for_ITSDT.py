...
class seqDataset(Dataset):
    def __init__(self, dataset_path, image_size, num_frame=5 ,type='train'):
        ...
        # fTODO cap_idx为
            # 0000 =
            # '/home/public/ITSDT/images/1/0.bmp'
            # 0001 =
            # '/home/public/ITSDT/images/1/1.bmp'
        description = pickle.load(open('mediate_data/emb_train_ITSDT.pkl', 'rb'))
        ...
        relation = pickle.load(open('mediate_data/motion_relation_ITSDT.pkl', 'rb'))
